...
import { PetsTableToolbar } from "@/components/pages/pets/table/pets-table-toolbar";
import type { PetItem } from "@/types/pets/pet.type";

type PetsDataTableProps = {
  columns: ColumnDef<PetItem>[];
  data: PetItem[];
  onCreate: () => void;
};
...
export function PetsDataTable({
  ...
  return (
    <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
      <PetsTableToolbar table={table} onCreate={onCreate} />
