...
import { UserRoleTableToolbar } from "@/components/pages/user-role/table/user-role-table-toolbar";
import type { UserRoleItem } from "@/types/user-role/user-role-type";

type UserRoleDataTableProps = {
  columns: ColumnDef<UserRoleItem>[];
  data: UserRoleItem[];
  onCreate: () => void;
};
...
export function UserRoleDataTable({
  ...
  return (
    <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
      <UserRoleTableToolbar table={table} onCreate={onCreate} />
          ...
          <TableBody>
            {table.getRowModel().rows.length ? (
              ...
              <TableRow>
                ...
                >
                  No hay asignaciones de roles para mostrar.
                </TableCell>
              </TableRow>
            )}
          </TableBody>
