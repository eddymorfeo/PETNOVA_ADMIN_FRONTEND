...
import { AppointmentsTableToolbar } from "@/components/pages/appointments/table/appointments-table-toolbar";
import type { AppointmentItem } from "@/types/appointments/appointment-type";

type AppointmentsDataTableProps = {
  columns: ColumnDef<AppointmentItem>[];
...
export function AppointmentsDataTable({
  ...
  return (
    <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
      <AppointmentsTableToolbar table={table} onCreate={onCreate} />
