...
import { ClientsTableToolbar } from "@/components/pages/clients/table/clients-table-toolbar";
import type { ClientItem } from "@/types/clients/client.type";

type ClientsDataTableProps = {
  columns: ColumnDef<ClientItem>[];
  data: ClientItem[];
  onCreate: () => void;
};
...
export function ClientsDataTable({
  ...
  return (
    <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
      <ClientsTableToolbar table={table} onCreate={onCreate} />
